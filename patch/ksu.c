...
// --- Mulai Injeksi Patch KSU Cmdline ---
...
{
	// Pengecekan parameter cmdline di awal inisialisasi
	if (enable_ksu < 1) {
		pr_info("KernelSU is disabled by cmdline\n");
		return 0; // Menghentikan seluruh proses inisialisasi KernelSU
	}
